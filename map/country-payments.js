...
window.COUNTRY_PAYMENTS = {
  ...
  "TW": { // 台灣
    ...
    methods: {
      ...
      ewallet        : ["line_pay", "jko_pay", "taiwan_pay", "easy_wallet", "apple_pay", "google_pay", "samsung_pay", "paypal", "pxpay_plus", "pi_app", "plus_pay", "ez_pay", "i_pass_money", "icash_pay"],
      ...
      cash_store     : ["seven_eleven_tw", "family_mart_tw", "hi_life_tw", "ok_mart_tw", "unnamed_tw_7"],
      bnpl           : ["zingala", "aftee"],
    }
  },
  "HK": { // 香港
